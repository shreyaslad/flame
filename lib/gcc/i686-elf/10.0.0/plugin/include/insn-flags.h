...
#define HAVE_movsi 1
#define HAVE_movdi 1
#define HAVE_movstrictqi (!TARGET_PARTIAL_REG_STALL || optimize_function_for_size_p (cfun))
#define HAVE_movstricthi (!TARGET_PARTIAL_REG_STALL || optimize_function_for_size_p (cfun))
