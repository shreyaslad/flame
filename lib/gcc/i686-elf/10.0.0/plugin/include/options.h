...
#define OPTION_MASK_ISA_AVX512BF16 (HOST_WIDE_INT_1U << 2)
...
#define OPTION_MASK_ISA_AVX512VP2INTERSECT (HOST_WIDE_INT_1U << 3)
...
#define OPTION_MASK_ISA_CLDEMOTE (HOST_WIDE_INT_1U << 4)
#define OPTION_MASK_ISA_CLFLUSHOPT (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_ISA_CLWB (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_ISA_CLZERO (HOST_WIDE_INT_1U << 5)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1U << 6)
#define OPTION_MASK_ISA_ENQCMD (HOST_WIDE_INT_1U << 7)
...
#define OPTION_MASK_ISA_HLE (HOST_WIDE_INT_1U << 8)
...
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1U << 9)
#define OPTION_MASK_ISA_MOVDIR64B (HOST_WIDE_INT_1U << 10)
#define OPTION_MASK_ISA_MOVDIRI (HOST_WIDE_INT_1U << 37)
#define MASK_MS_BITFIELD_LAYOUT (1U << 18)
#define OPTION_MASK_ISA_MWAITX (HOST_WIDE_INT_1U << 11)
...
#define OPTION_MASK_ISA_PCONFIG (HOST_WIDE_INT_1U << 12)
...
#define OPTION_MASK_ISA_PTWRITE (HOST_WIDE_INT_1U << 13)
#define OPTION_MASK_ISA_RDPID (HOST_WIDE_INT_1U << 14)
...
#define OPTION_MASK_ISA_SGX (HOST_WIDE_INT_1U << 15)
...
#define OPTION_MASK_ISA_VAES (HOST_WIDE_INT_1U << 16)
#define MASK_VECT8_RETURNS (1U << 28)
#define OPTION_MASK_ISA_VPCLMULQDQ (HOST_WIDE_INT_1U << 57)
#define MASK_VZEROUPPER (1U << 29)
#define OPTION_MASK_ISA_WAITPKG (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_ISA_WBNOINVD (HOST_WIDE_INT_1U << 18)
...
#define TARGET_ISA_AVX512BF16 ((ix86_isa_flags2 & OPTION_MASK_ISA_AVX512BF16) != 0)
#define TARGET_ISA_AVX512BF16_P(ix86_isa_flags2) (((ix86_isa_flags2) & OPTION_MASK_ISA_AVX512BF16) != 0)
...
#define TARGET_ISA_AVX512VP2INTERSECT ((ix86_isa_flags2 & OPTION_MASK_ISA_AVX512VP2INTERSECT) != 0)
#define TARGET_ISA_AVX512VP2INTERSECT_P(ix86_isa_flags2) (((ix86_isa_flags2) & OPTION_MASK_ISA_AVX512VP2INTERSECT) != 0)
...
#define TARGET_ISA_ENQCMD ((ix86_isa_flags2 & OPTION_MASK_ISA_ENQCMD) != 0)
#define TARGET_ISA_ENQCMD_P(ix86_isa_flags2) (((ix86_isa_flags2) & OPTION_MASK_ISA_ENQCMD) != 0)
...
enum opt_code
{
  ...
  OPT_Werror = 243,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 244, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 245,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 246,           /* -Wexpansion-to-defined */
  OPT_Wextra = 247,                          /* -Wextra */
  OPT_Wextra_semi = 248,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 249,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 250,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 251,                    /* -Wfloat-equal */
  /* OPT_Wformat = 252, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 253,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 254,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 255,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 256,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 257, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 258,               /* -Wformat-overflow= */
  OPT_Wformat_security = 259,                /* -Wformat-security */
  OPT_Wformat_signedness = 260,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 261, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 262,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 263,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 264,             /* -Wformat-zero-length */
  OPT_Wformat_ = 265,                        /* -Wformat= */
  OPT_Wframe_address = 266,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 267,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 268,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 269,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 270,           /* -Wfunction-elimination */
  OPT_Whsa = 271,                            /* -Whsa */
  OPT_Wif_not_aligned = 272,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 273,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 274,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 275,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 276, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 277,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 278,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 279,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 280,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 281,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 282, */                   /* -Wimport */
  OPT_Winaccessible_base = 283,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 284,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 285,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 286,             /* -Winit-list-lifetime */
  OPT_Winit_self = 287,                      /* -Winit-self */
  OPT_Winline = 288,                         /* -Winline */
  OPT_Wint_conversion = 289,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 290,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 291,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 292,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 293,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 294,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 295,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 296,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 297,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 298,               /* -Wjump-misses-init */
  OPT_Wl_ = 299,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 300, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 301,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 302,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 303,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 304,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 305,                     /* -Wlogical-op */
  OPT_Wlong_long = 306,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 307,              /* -Wlto-type-mismatch */
  OPT_Wmain = 308,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 309,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 310,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 311,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 312,         /* -Wmisleading-indentation */
  OPT_Wmissing_attributes = 313,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 314,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 315,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 316,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 317, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 318,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 319, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 320,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 321,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 322,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 323,                        /* -Wmudflap */
  OPT_Wmultichar = 324,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 325,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 326,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 327,                     /* -Wnamespaces */
  OPT_Wnarrowing = 328,                      /* -Wnarrowing */
  OPT_Wnested_externs = 329,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 330, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 331, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_vla_larger_than = 332, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 333,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 334,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 335,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 336,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 337,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 338,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 339, */               /* -Wnormalized */
  OPT_Wnormalized_ = 340,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 341,               /* -Wnull-dereference */
  OPT_Wodr = 342,                            /* -Wodr */
  OPT_Wold_style_cast = 343,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 344,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 345,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 346,                    /* -Wopenmp-simd */
  OPT_Woverflow = 347,                       /* -Woverflow */
  OPT_Woverlength_strings = 348,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 349,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 350,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 351,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 352,                             /* -Wp, */
  OPT_Wpacked = 353,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 354,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 355,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 356,                         /* -Wpadded */
  OPT_Wparentheses = 357,                    /* -Wparentheses */
  OPT_Wpedantic = 358,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 359,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 360, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 361,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 362,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 363,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 364,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 365,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 366,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 367,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 368,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 369,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 370,                       /* -Wprotocol */
  OPT_Wpsabi = 371,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 372,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 373,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 374,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 375,                /* -Wredundant-decls */
  OPT_Wredundant_move = 376,                 /* -Wredundant-move */
  OPT_Wregister = 377,                       /* -Wregister */
  OPT_Wreorder = 378,                        /* -Wreorder */
  OPT_Wrestrict = 379,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 380,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 381,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 382,           /* -Wscalar-storage-order */
  OPT_Wselector = 383,                       /* -Wselector */
  OPT_Wsequence_point = 384,                 /* -Wsequence-point */
  OPT_Wshadow = 385,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 386, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 387,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 388, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 389,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 390, */            /* -Wshadow=global */
  OPT_Wshadow_local = 391,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 392,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 393,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 394,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 395, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 396,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 397,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 398,                /* -Wsign-conversion */
  OPT_Wsign_promo = 399,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 400,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 401,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 402,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 403,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 404,                    /* -Wspeculative */
  OPT_Wstack_protector = 405,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 406,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 407,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 408,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 409,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 410,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 411,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 412,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 413,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 414, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 415,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 416,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 417,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 418,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 419,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 420,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 421,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 422,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 423,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 424,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 425,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 426,               /* -Wsuggest-override */
  OPT_Wsurprising = 427,                     /* -Wsurprising */
  OPT_Wswitch = 428,                         /* -Wswitch */
  OPT_Wswitch_bool = 429,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 430,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 431,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 432,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 433,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 434,                      /* -Wsync-nand */
  OPT_Wsynth = 435,                          /* -Wsynth */
  OPT_Wsystem_headers = 436,                 /* -Wsystem-headers */
  OPT_Wtabs = 437,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 438,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 439,           /* -Wtautological-compare */
  OPT_Wtemplates = 440,                      /* -Wtemplates */
  OPT_Wterminate = 441,                      /* -Wterminate */
  OPT_Wtraditional = 442,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 443,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 444,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 445,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 446,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 447,            /* -Wundeclared-selector */
  OPT_Wundef = 448,                          /* -Wundef */
  OPT_Wundefined_do_loop = 449,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 450,                      /* -Wunderflow */
  OPT_Wuninitialized = 451,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 452,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 453, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 454, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 455,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 456,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 457,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 458,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 459, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 460,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 461,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 462,                /* -Wunused-function */
  OPT_Wunused_label = 463,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 464,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 465,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 466,               /* -Wunused-parameter */
  OPT_Wunused_result = 467,                  /* -Wunused-result */
  OPT_Wunused_value = 468,                   /* -Wunused-value */
  OPT_Wunused_variable = 469,                /* -Wunused-variable */
  OPT_Wuse_without_only = 470,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 471,                   /* -Wuseless-cast */
  OPT_Wvarargs = 472,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 473,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 474,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 475,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 476,            /* -Wvirtual-move-assign */
  OPT_Wvla = 477,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 478,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 479,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 480,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 481,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 482,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 483,                       /* -Wzerotrip */
  OPT_X = 484,                               /* -X */
  OPT_Xassembler = 485,                      /* -Xassembler */
  OPT_Xf = 486,                              /* -Xf */
  OPT_Xlinker = 487,                         /* -Xlinker */
  OPT_Xpreprocessor = 488,                   /* -Xpreprocessor */
  OPT_Z = 489,                               /* -Z */
  OPT_ansi = 490,                            /* -ansi */
  OPT_aux_info = 491,                        /* -aux-info */
  /* OPT_aux_info_ = 492, */                 /* -aux-info= */
  OPT_auxbase = 493,                         /* -auxbase */
  OPT_auxbase_strip = 494,                   /* -auxbase-strip */
  OPT_c = 495,                               /* -c */
  OPT_callgraph = 496,                       /* -callgraph */
  OPT_coverage = 497,                        /* -coverage */
  OPT_cpp = 498,                             /* -cpp */
  OPT_cpp_ = 499,                            /* -cpp= */
  OPT_d = 500,                               /* -d */
  OPT_debuglib_ = 501,                       /* -debuglib= */
  OPT_defaultlib_ = 502,                     /* -defaultlib= */
  OPT_defined_only = 503,                    /* -defined-only */
  OPT_demangle = 504,                        /* -demangle */
  OPT_dstartfiles = 505,                     /* -dstartfiles */
  OPT_dump_body_ = 506,                      /* -dump-body= */
  OPT_dump_level_ = 507,                     /* -dump-level= */
  OPT_dumpbase = 508,                        /* -dumpbase */
  OPT_dumpdir = 509,                         /* -dumpdir */
  OPT_dumpfullversion = 510,                 /* -dumpfullversion */
  OPT_dumpmachine = 511,                     /* -dumpmachine */
  OPT_dumpspecs = 512,                       /* -dumpspecs */
  OPT_dumpversion = 513,                     /* -dumpversion */
  OPT_e = 514,                               /* -e */
  OPT_export_dynamic = 515,                  /* -export-dynamic */
  OPT_fPIC = 516,                            /* -fPIC */
  OPT_fPIE = 517,                            /* -fPIE */
  OPT_fRTS_ = 518,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 519,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 520,                   /* -fabi-version= */
  OPT_faccess_control = 521,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 522,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 523,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 524,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 525,                  /* -falign-commons */
  OPT_falign_functions = 526,                /* -falign-functions */
  OPT_falign_functions_ = 527,               /* -falign-functions= */
  OPT_falign_jumps = 528,                    /* -falign-jumps */
  OPT_falign_jumps_ = 529,                   /* -falign-jumps= */
  OPT_falign_labels = 530,                   /* -falign-labels */
  OPT_falign_labels_ = 531,                  /* -falign-labels= */
  OPT_falign_loops = 532,                    /* -falign-loops */
  OPT_falign_loops_ = 533,                   /* -falign-loops= */
  /* OPT_faligned_new = 534, */              /* -faligned-new */
  OPT_faligned_new_ = 535,                   /* -faligned-new= */
  OPT_fall_instantiations = 536,             /* -fall-instantiations */
  OPT_fall_intrinsics = 537,                 /* -fall-intrinsics */
  OPT_fall_virtual = 538,                    /* -fall-virtual */
  OPT_fallocation_dce = 539,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 540,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 541,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 542,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 543,/* -fallow-parameterless-variadic-functions */
  OPT_falt_external_templates = 544,         /* -falt-external-templates */
  /* OPT_fargument_alias = 545, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 546, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 547, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 548, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 549,            /* -fasan-shadow-offset= */
  OPT_fasm = 550,                            /* -fasm */
  OPT_fassert = 551,                         /* -fassert */
  OPT_fassociative_math = 552,               /* -fassociative-math */
  OPT_fassume_phsa = 553,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 554,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 555,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 556,                   /* -fauto-profile */
  OPT_fauto_profile_ = 557,                  /* -fauto-profile= */
  OPT_fautomatic = 558,                      /* -fautomatic */
  OPT_fbackslash = 559,                      /* -fbackslash */
  OPT_fbacktrace = 560,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 561,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 562,                   /* -fbounds-check */
  OPT_fbounds_check_ = 563,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 564,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 565,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 566,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 567,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 568,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 569,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 570,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 571,                        /* -fbuiltin */
  OPT_fbuiltin_ = 572,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 573,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 574,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 575,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 576,                    /* -fcall-saved- */
  OPT_fcall_used_ = 577,                     /* -fcall-used- */
  OPT_fcaller_saves = 578,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 579,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 580, */            /* -fcf-protection */
  OPT_fcf_protection_ = 581,                 /* -fcf-protection= */
  OPT_fchar8_t = 582,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 583,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 584, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 585,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 586,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 587,                         /* -fcheck= */
  OPT_fchecking = 588,                       /* -fchecking */
  OPT_fchecking_ = 589,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 590,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 591,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 592,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 593,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 594,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 595,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 596,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 597,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 598, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 599,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 600,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 601,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 602, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 603,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 604,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 605,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 606,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 607,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 608, */                 /* -fcilkplus */
  OPT_fcoarray_ = 609,                       /* -fcoarray= */
  OPT_fcode_hoisting = 610,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 611,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 612,                         /* -fcommon */
  OPT_fcompare_debug = 613,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 614,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 615,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 616,                   /* -fcompare-elim */
  OPT_fconcepts = 617,                       /* -fconcepts */
  OPT_fcond_mismatch = 618,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 619, */           /* -fconserve-space */
  OPT_fconserve_stack = 620,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 621,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 622,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 623,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 624,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 625,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 626,                       /* -fconvert= */
  OPT_fcprop_registers = 627,                /* -fcprop-registers */
  OPT_fcray_pointer = 628,                   /* -fcray-pointer */
  OPT_fcrossjumping = 629,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 630,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 631, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 632,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 633,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 634,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 635,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 636,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 637,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 638,                       /* -fdbg-cnt= */
  OPT_fdce = 639,                            /* -fdce */
  OPT_fdebug = 640,                          /* -fdebug */
  OPT_fdebug_cpp = 641,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 642,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 643,            /* -fdebug-types-section */
  OPT_fdebug_ = 644,                         /* -fdebug= */
  OPT_fdec = 645,                            /* -fdec */
  OPT_fdec_blank_format_item = 646,          /* -fdec-blank-format-item */
  OPT_fdec_format_defaults = 647,            /* -fdec-format-defaults */
  OPT_fdec_include = 648,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 649,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 650,                       /* -fdec-math */
  OPT_fdec_static = 651,                     /* -fdec-static */
  OPT_fdec_structure = 652,                  /* -fdec-structure */
  ...
  OPT_fdefault_real_10 = 658,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 659,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 660,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 661,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 662,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 663,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 664,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 665,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 666,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 667,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 668, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 669,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 670,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 671,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 672,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 673,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 674,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 675,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 676,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 677,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 678,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 679, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 680,                /* -fdirectives-only */
  OPT_fdisable_ = 681,                       /* -fdisable- */
  OPT_fdoc = 682,                            /* -fdoc */
  OPT_fdoc_dir_ = 683,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 684,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 685,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 686,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 687,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 688,                       /* -fdruntime */
  OPT_fdse = 689,                            /* -fdse */
  OPT_fdump_ = 690,                          /* -fdump- */
  OPT_fdump_ada_spec = 691,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 692,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 693, */                /* -fdump-core */
  OPT_fdump_d_original = 694,                /* -fdump-d-original */
  OPT_fdump_final_insns = 695,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 696,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 697,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 698,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 699,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 700,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 701,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 702,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 703, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 704,                    /* -fdump-passes */
  OPT_fdump_scos = 705,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 706,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 707,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 708,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 709,                 /* -fearly-inlining */
  OPT_felide_constructors = 710,             /* -felide-constructors */
  OPT_felide_type = 711,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 712, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 713, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 714,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 715,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 716,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 717,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 718,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 719,                        /* -fenable- */
  OPT_fenforce_eh_specs = 720,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 721,                 /* -fenum-int-equiv */
  OPT_fexceptions = 722,                     /* -fexceptions */
  OPT_fexcess_precision_ = 723,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 724,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 725,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 726,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 727,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 728,                /* -fextern-tls-init */
  OPT_fexternal_blas = 729,                  /* -fexternal-blas */
  OPT_fexternal_templates = 730,             /* -fexternal-templates */
  OPT_ff2c = 731,                            /* -ff2c */
  OPT_ffast_math = 732,                      /* -ffast-math */
  OPT_ffat_lto_objects = 733,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 734,               /* -ffile-prefix-map= */
  OPT_ffinite_loops = 735,                   /* -ffinite-loops */
  OPT_ffinite_math_only = 736,               /* -ffinite-math-only */
  OPT_ffixed_ = 737,                         /* -ffixed- */
  OPT_ffixed_form = 738,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 739,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 740,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 741,                    /* -ffloat-store */
  OPT_ffor_scope = 742,                      /* -ffor-scope */
  /* OPT_fforce_addr = 743, */               /* -fforce-addr */
  OPT_fforward_propagate = 744,              /* -fforward-propagate */
  OPT_ffp_contract_ = 745,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 746,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 747,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 748,                      /* -ffpe-trap= */
  OPT_ffree_form = 749,                      /* -ffree-form */
  OPT_ffree_line_length_ = 750,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 751,          /* -ffree-line-length-none */
  OPT_ffreestanding = 752,                   /* -ffreestanding */
  OPT_ffriend_injection = 753,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 754,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 755,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 756,                   /* -ffunction-cse */
  OPT_ffunction_sections = 757,              /* -ffunction-sections */
  OPT_fgcse = 758,                           /* -fgcse */
  OPT_fgcse_after_reload = 759,              /* -fgcse-after-reload */
  OPT_fgcse_las = 760,                       /* -fgcse-las */
  OPT_fgcse_lm = 761,                        /* -fgcse-lm */
  OPT_fgcse_sm = 762,                        /* -fgcse-sm */
  OPT_fgimple = 763,                         /* -fgimple */
  OPT_fgnat_encodings_ = 764,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 765,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 766,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 767,                         /* -fgnu-tm */
  OPT_fgnu_unique = 768,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 769,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 770,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 771,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 772,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 773,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 774,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 775,          /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 776,          /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 777,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 778,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 779,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 780,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 781,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 782,                       /* -fgraphite */
  OPT_fgraphite_identity = 783,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 784,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 785,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 786, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 787, */                     /* -fhelp */
  /* OPT_fhelp_ = 788, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 789,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 790,                      /* -fhonor-std */
  OPT_fhosted = 791,                         /* -fhosted */
  OPT_fhuge_objects = 792,                   /* -fhuge-objects */
  OPT_fident = 793,                          /* -fident */
  OPT_fif_conversion = 794,                  /* -fif-conversion */
  OPT_fif_conversion2 = 795,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 796,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 797,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 798,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 799,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 800,             /* -fimplicit-templates */
  OPT_findirect_inlining = 801,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 802,         /* -finhibit-size-directive */
  OPT_finit_character_ = 803,                /* -finit-character= */
  OPT_finit_derived = 804,                   /* -finit-derived */
  OPT_finit_integer_ = 805,                  /* -finit-integer= */
  OPT_finit_local_zero = 806,                /* -finit-local-zero */
  OPT_finit_logical_ = 807,                  /* -finit-logical= */
  OPT_finit_real_ = 808,                     /* -finit-real= */
  OPT_finline = 809,                         /* -finline */
  OPT_finline_atomics = 810,                 /* -finline-atomics */
  OPT_finline_functions = 811,               /* -finline-functions */
  OPT_finline_functions_called_once = 812,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 813, */            /* -finline-limit- */
  OPT_finline_limit_ = 814,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 815,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 816,         /* -finline-small-functions */
  OPT_finput_charset_ = 817,                 /* -finput-charset= */
  OPT_finstrument_functions = 818,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 819,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 820,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 821,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 822,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 823,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 824,                     /* -finvariants */
  OPT_fipa_bit_cp = 825,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 826,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 827, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 828,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 829,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 830,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 831,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 832, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 833,                    /* -fipa-profile */
  OPT_fipa_pta = 834,                        /* -fipa-pta */
  OPT_fipa_pure_const = 835,                 /* -fipa-pure-const */
  OPT_fipa_ra = 836,                         /* -fipa-ra */
  OPT_fipa_reference = 837,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 838,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 839,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 840,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 841, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 842,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 843,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 844,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 845,              /* -fira-loop-pressure */
  OPT_fira_region_ = 846,                    /* -fira-region= */
  OPT_fira_share_save_slots = 847,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 848,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 849,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 850,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 851,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 852,               /* -fivar-visibility= */
  OPT_fivopts = 853,                         /* -fivopts */
  OPT_fjump_tables = 854,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 855,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 856,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 857,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 858,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 859,          /* -fkeep-static-functions */
  OPT_flabels_ok = 860,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 861,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 862,             /* -fleading-underscore */
  OPT_flifetime_dse = 863,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 864,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 865,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 866,                 /* -flinker-output= */
  /* OPT_flive_patching = 867, */            /* -flive-patching */
  OPT_flive_patching_ = 868,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 869,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 870,                    /* -flocal-ivars */
  /* OPT_floop_block = 871, */               /* -floop-block */
  /* OPT_floop_flatten = 872, */             /* -floop-flatten */
  OPT_floop_interchange = 873,               /* -floop-interchange */
  OPT_floop_nest_optimize = 874,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 875, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 876,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 877, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 878,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 879,                      /* -flra-remat */
  OPT_flto = 880,                            /* -flto */
  OPT_flto_compression_level_ = 881,         /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 882, */     /* -flto-odr-type-merging */
  OPT_flto_partition_ = 883,                 /* -flto-partition= */
  OPT_flto_report = 884,                     /* -flto-report */
  OPT_flto_report_wpa = 885,                 /* -flto-report-wpa */
  OPT_flto_ = 886,                           /* -flto= */
  OPT_fltrans = 887,                         /* -fltrans */
  OPT_fltrans_output_list_ = 888,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 889,              /* -fmacro-prefix-map= */
  OPT_fmain = 890,                           /* -fmain */
  OPT_fmath_errno = 891,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 892,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 893,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 894,         /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 895,             /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 896,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 897,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 898,                     /* -fmem-report */
  OPT_fmem_report_wpa = 899,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 900,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 901,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 902,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 903,                /* -fmessage-length= */
  OPT_fmodule_file_ = 904,                   /* -fmodule-file= */
  OPT_fmodule_private = 905,                 /* -fmodule-private */
  OPT_fmoduleinfo = 906,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 907,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 908,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 909,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 910,                  /* -fms-extensions */
  OPT_fmudflap = 911,                        /* -fmudflap */
  OPT_fmudflapir = 912,                      /* -fmudflapir */
  OPT_fmudflapth = 913,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 914,         /* -fname-mangling-version- */
  OPT_fnew_abi = 915,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 916,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 917,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 918,                   /* -fnext-runtime */
  OPT_fnil_receivers = 919,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 920,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 921,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 922,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 923,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 924,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 925,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 926,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 927,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 928,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 929,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 930,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 931,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 932,                   /* -foffload-abi= */
  OPT_foffload_ = 933,                       /* -foffload= */
  OPT_fomit_frame_pointer = 934,             /* -fomit-frame-pointer */
  OPT_fonly_ = 935,                          /* -fonly= */
  OPT_fopenacc = 936,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 937,                   /* -fopenacc-dim= */
  OPT_fopenmp = 938,                         /* -fopenmp */
  OPT_fopenmp_simd = 939,                    /* -fopenmp-simd */
  OPT_foperator_names = 940,                 /* -foperator-names */
  OPT_fopt_info = 941,                       /* -fopt-info */
  OPT_fopt_info_ = 942,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 943, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 944,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 945,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 946, */           /* -foptional-diags */
  OPT_fpack_derived = 947,                   /* -fpack-derived */
  OPT_fpack_struct = 948,                    /* -fpack-struct */
  OPT_fpack_struct_ = 949,                   /* -fpack-struct= */
  OPT_fpad_source = 950,                     /* -fpad-source */
  OPT_fpartial_inlining = 951,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 952,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 953,              /* -fpcc-struct-return */
  OPT_fpch_deps = 954,                       /* -fpch-deps */
  OPT_fpch_preprocess = 955,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 956,                     /* -fpeel-loops */
  OPT_fpeephole = 957,                       /* -fpeephole */
  OPT_fpeephole2 = 958,                      /* -fpeephole2 */
  OPT_fpermissive = 959,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 960,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 961,                            /* -fpic */
  OPT_fpie = 962,                            /* -fpie */
  OPT_fplan9_extensions = 963,               /* -fplan9-extensions */
  OPT_fplt = 964,                            /* -fplt */
  OPT_fplugin_arg_ = 965,                    /* -fplugin-arg- */
  OPT_fplugin_ = 966,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 967,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 968,                 /* -fpostconditions */
  OPT_fpre_include_ = 969,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 970,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 971,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 972,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 973,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 974,                   /* -fpreprocessed */
  OPT_fpretty_templates = 975,               /* -fpretty-templates */
  OPT_fprintf_return_value = 976,            /* -fprintf-return-value */
  OPT_fprofile = 977,                        /* -fprofile */
  OPT_fprofile_abs_path = 978,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 979,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 980,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 981,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 982,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 983,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 984,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 985,              /* -fprofile-generate= */
  OPT_fprofile_note_ = 986,                  /* -fprofile-note= */
  OPT_fprofile_reorder_functions = 987,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 988,                 /* -fprofile-report */
  OPT_fprofile_update_ = 989,                /* -fprofile-update= */
  OPT_fprofile_use = 990,                    /* -fprofile-use */
  OPT_fprofile_use_ = 991,                   /* -fprofile-use= */
  OPT_fprofile_values = 992,                 /* -fprofile-values */
  OPT_fprotect_parens = 993,                 /* -fprotect-parens */
  OPT_frandom_seed = 994,                    /* -frandom-seed */
  OPT_frandom_seed_ = 995,                   /* -frandom-seed= */
  OPT_frange_check = 996,                    /* -frange-check */
  OPT_freal_4_real_10 = 997,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 998,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 999,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1000,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1001,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1002,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1003,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1004,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1005,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1006,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1007,               /* -frecord-marker=8 */
  OPT_frecursive = 1008,                     /* -frecursive */
  OPT_free = 1009,                           /* -free */
  OPT_freg_struct_return = 1010,             /* -freg-struct-return */
  /* OPT_fregmove = 1011, */                 /* -fregmove */
  OPT_frelease = 1012,                       /* -frelease */
  OPT_frename_registers = 1013,              /* -frename-registers */
  OPT_freorder_blocks = 1014,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1015,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1016,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1017,             /* -freorder-functions */
  OPT_frepack_arrays = 1018,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1019,          /* -freplace-objc-classes */
  OPT_frepo = 1020,                          /* -frepo */
  OPT_freport_bug = 1021,                    /* -freport-bug */
  OPT_frequire_return_statement = 1022,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1023,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1024, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1025,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1026,                   /* -fresolution= */
  OPT_frounding_math = 1027,                 /* -frounding-math */
  OPT_frtti = 1028,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1029,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1030,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1031,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1032,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1033,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1034,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1035,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1036,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1037, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1038,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1039,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1040,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1041,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1042,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1043,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1044,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1045,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1046,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1047,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1048,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1049,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1050,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1051,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1052,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1053,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1054, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1055,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1056,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1057,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1058,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1059,               /* -fsection-anchors */
  /* OPT_fsee = 1060, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1061,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1062,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1063,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1064,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1065,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1066,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1067,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1068,                   /* -fshort-enums */
  OPT_fshort_wchar = 1069,                   /* -fshort-wchar */
  OPT_fshow_column = 1070,                   /* -fshow-column */
  OPT_fshrink_wrap = 1071,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1072,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1073,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1074,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1075,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1076,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1077,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1078,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1079,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1080,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1081,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1082,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1083,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1084,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1085,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1086,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1087,                      /* -fsquangle */
  OPT_fssa_backprop = 1088,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1089,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1090,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1091,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1092, */             /* -fstack-check */
  OPT_fstack_check_ = 1093,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1094,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1095,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1096,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1097,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1098,               /* -fstack-protector */
  OPT_fstack_protector_all = 1099,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1100,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1101,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1102,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1103,                   /* -fstack-usage */
  OPT_fstats = 1104,                         /* -fstats */
  OPT_fstdarg_opt = 1105,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1106,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1107, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1108,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1109,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1110,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1111,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1112,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1113, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1114,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1115,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1116,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1117,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1118,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1119, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1120,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1121, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1122,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1123, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1124,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1125,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1126,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1127,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1128,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1129,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1130,                   /* -ftime-report */
  OPT_ftime_report_details = 1131,           /* -ftime-report-details */
  OPT_ftls_model_ = 1132,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1133,              /* -ftoplevel-reorder */
  OPT_ftracer = 1134,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1135,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1136,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1137,                   /* -ftrampolines */
  OPT_ftransition_all = 1138,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1139,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1140,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1141,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1142,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1143,              /* -ftransition=field */
  OPT_ftransition_import = 1144,             /* -ftransition=import */
  OPT_ftransition_nogc = 1145,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1146,                /* -ftransition=tls */
  OPT_ftrapping_math = 1147,                 /* -ftrapping-math */
  OPT_ftrapv = 1148,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1149,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1150,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1151,                      /* -ftree-ccp */
  OPT_ftree_ch = 1152,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1153, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1154,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1155,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1156, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1157,                   /* -ftree-cselim */
  OPT_ftree_dce = 1158,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1159,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1160,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1161,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1162,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1163, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1164,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1165,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1166, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1167,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1168,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1169, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1170,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1171,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1172,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1173,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1174,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1175,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1176,                      /* -ftree-pre */
  OPT_ftree_pta = 1177,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1178,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1179, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1180,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1181,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1182,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1183,                     /* -ftree-slsr */
  OPT_ftree_sra = 1184,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1185, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1186, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1187,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1188,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1189,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1190, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1191,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1192, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1193,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1194,         /* -funconstrained-commons */
  OPT_funderscoring = 1195,                  /* -funderscoring */
  OPT_funit_at_a_time = 1196,                /* -funit-at-a-time */
  OPT_funittest = 1197,                      /* -funittest */
  OPT_funroll_all_loops = 1198,              /* -funroll-all-loops */
  OPT_funroll_loops = 1199,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1200, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1201,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1202,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1203,                 /* -funsigned-char */
  OPT_funswitch_loops = 1204,                /* -funswitch-loops */
  OPT_funwind_tables = 1205,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1206,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1207,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1208,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1209,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1210,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1211,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1212,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1213,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1214,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1215,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1216,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1217, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1218,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1219,                   /* -fverbose-asm */
  /* OPT_fversion = 1220, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1221,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1222,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1223,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1224,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1225,                   /* -fvisibility= */
  OPT_fvpt = 1226,                           /* -fvpt */
  OPT_fvtable_gc = 1227,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1228,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1229,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1230,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1231,                     /* -fvtv-debug */
  OPT_fweak = 1232,                          /* -fweak */
  OPT_fweb = 1233,                           /* -fweb */
  /* OPT_fwhole_file = 1234, */              /* -fwhole-file */
  OPT_fwhole_program = 1235,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1236,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1237,             /* -fworking-directory */
  OPT_fwpa = 1238,                           /* -fwpa */
  OPT_fwpa_ = 1239,                          /* -fwpa= */
  OPT_fwrapv = 1240,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1241,                 /* -fwrapv-pointer */
  OPT_fxref = 1242,                          /* -fxref */
  /* OPT_fzee = 1243, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1244,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1245,                     /* -fzero-link */
  OPT_g = 1246,                              /* -g */
  OPT_gant = 1247,                           /* -gant */
  OPT_gas_loc_support = 1248,                /* -gas-loc-support */
  OPT_gas_locview_support = 1249,            /* -gas-locview-support */
  OPT_gcoff = 1250,                          /* -gcoff */
  OPT_gcoff1 = 1251,                         /* -gcoff1 */
  OPT_gcoff2 = 1252,                         /* -gcoff2 */
  OPT_gcoff3 = 1253,                         /* -gcoff3 */
  OPT_gcolumn_info = 1254,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1255,                 /* -gdescribe-dies */
  OPT_gdwarf = 1256,                         /* -gdwarf */
  OPT_gdwarf_ = 1257,                        /* -gdwarf- */
  OPT_gen_decls = 1258,                      /* -gen-decls */
  OPT_ggdb = 1259,                           /* -ggdb */
  OPT_ggnu_pubnames = 1260,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1261,                   /* -gimple-stats */
  OPT_ginline_points = 1262,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1263, /* -ginternal-reset-location-views */
  OPT_gnat = 1264,                           /* -gnat */
  OPT_gnatO = 1265,                          /* -gnatO */
  OPT_gno_ = 1266,                           /* -gno- */
  OPT_gno_pubnames = 1267,                   /* -gno-pubnames */
  OPT_gpubnames = 1268,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1269,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1270,                   /* -gsplit-dwarf */
  OPT_gstabs = 1271,                         /* -gstabs */
  OPT_gstabs_ = 1272,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1273,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1274,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1275,                        /* -gtoggle */
  OPT_gvariable_location_views = 1276,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1277,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1278,                           /* -gvms */
  OPT_gxcoff = 1279,                         /* -gxcoff */
  OPT_gxcoff_ = 1280,                        /* -gxcoff+ */
  OPT_gz = 1281,                             /* -gz */
  OPT_gz_ = 1282,                            /* -gz= */
  OPT_h = 1283,                              /* -h */
  OPT_help = 1284,                           /* -help */
  OPT_idirafter = 1285,                      /* -idirafter */
  OPT_imacros = 1286,                        /* -imacros */
  OPT_imultiarch = 1287,                     /* -imultiarch */
  OPT_imultilib = 1288,                      /* -imultilib */
  OPT_include = 1289,                        /* -include */
  OPT_iplugindir_ = 1290,                    /* -iplugindir= */
  OPT_iprefix = 1291,                        /* -iprefix */
  OPT_iquote = 1292,                         /* -iquote */
  OPT_isysroot = 1293,                       /* -isysroot */
  OPT_isystem = 1294,                        /* -isystem */
  OPT_iwithprefix = 1295,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1296,              /* -iwithprefixbefore */
  OPT_k8 = 1297,                             /* -k8 */
  OPT_l = 1298,                              /* -l */
  OPT_lang_asm = 1299,                       /* -lang-asm */
  OPT_list = 1300,                           /* -list */
  OPT_m128bit_long_double = 1301,            /* -m128bit-long-double */
  OPT_m16 = 1302,                            /* -m16 */
  OPT_m32 = 1303,                            /* -m32 */
  OPT_m3dnow = 1304,                         /* -m3dnow */
  OPT_m3dnowa = 1305,                        /* -m3dnowa */
  OPT_m64 = 1306,                            /* -m64 */
  OPT_m80387 = 1307,                         /* -m80387 */
  OPT_m8bit_idiv = 1308,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1309,             /* -m96bit-long-double */
  OPT_mabi_ = 1310,                          /* -mabi= */
  OPT_mabm = 1311,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1312,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1313,                 /* -maddress-mode= */
  OPT_madx = 1314,                           /* -madx */
  OPT_maes = 1315,                           /* -maes */
  OPT_malign_data_ = 1316,                   /* -malign-data= */
  OPT_malign_double = 1317,                  /* -malign-double */
  OPT_malign_functions_ = 1318,              /* -malign-functions= */
  OPT_malign_jumps_ = 1319,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1320,                  /* -malign-loops= */
  OPT_malign_stringops = 1321,               /* -malign-stringops */
  OPT_march_ = 1322,                         /* -march= */
  OPT_masm_ = 1323,                          /* -masm= */
  OPT_mavx = 1324,                           /* -mavx */
  OPT_mavx2 = 1325,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1326,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1327,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1328,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1329,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1330,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1331,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1332,                      /* -mavx512bw */
  OPT_mavx512cd = 1333,                      /* -mavx512cd */
  OPT_mavx512dq = 1334,                      /* -mavx512dq */
  OPT_mavx512er = 1335,                      /* -mavx512er */
  OPT_mavx512f = 1336,                       /* -mavx512f */
  OPT_mavx512ifma = 1337,                    /* -mavx512ifma */
  OPT_mavx512pf = 1338,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1339,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1340,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1341,                      /* -mavx512vl */
  OPT_mavx512vnni = 1342,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1343,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1344,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1345,                           /* -mbmi */
  OPT_mbmi2 = 1346,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1347,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1348,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1349,                    /* -mcet-switch */
  OPT_mcld = 1350,                           /* -mcld */
  OPT_mcldemote = 1351,                      /* -mcldemote */
  OPT_mclflushopt = 1352,                    /* -mclflushopt */
  OPT_mclwb = 1353,                          /* -mclwb */
  OPT_mclzero = 1354,                        /* -mclzero */
  OPT_mcmodel_ = 1355,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1356, */                    /* -mcpu= */
  OPT_mcrc32 = 1357,                         /* -mcrc32 */
  OPT_mcx16 = 1358,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1359,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1360,            /* -mdump-tune-features */
  OPT_menqcmd = 1361,                        /* -menqcmd */
  OPT_mf16c = 1362,                          /* -mf16c */
  OPT_mfancy_math_387 = 1363,                /* -mfancy-math-387 */
  OPT_mfentry = 1364,                        /* -mfentry */
  OPT_mfentry_name_ = 1365,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1366,               /* -mfentry-section= */
  OPT_mfma = 1367,                           /* -mfma */
  OPT_mfma4 = 1368,                          /* -mfma4 */
  OPT_mforce_drap = 1369,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1370,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1371,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1372,                       /* -mfpmath= */
  OPT_mfsgsbase = 1373,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1374,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1375, */              /* -mfused-madd */
  OPT_mfxsr = 1376,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1377,             /* -mgeneral-regs-only */
  OPT_mgfni = 1378,                          /* -mgfni */
  OPT_mhard_float = 1379,                    /* -mhard-float */
  OPT_mhle = 1380,                           /* -mhle */
  OPT_miamcu = 1381,                         /* -miamcu */
  OPT_mieee_fp = 1382,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1383,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1384,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1385,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1386,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1387,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1388,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1389, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1390,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1391,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1392,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1393,                /* -mlong-double-80 */
  OPT_mlwp = 1394,                           /* -mlwp */
  OPT_mlzcnt = 1395,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1396,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1397,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1398,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1399,                  /* -mmitigate-rop */
  OPT_mmmx = 1400,                           /* -mmmx */
  OPT_mmovbe = 1401,                         /* -mmovbe */
  OPT_mmovdir64b = 1402,                     /* -mmovdir64b */
  OPT_mmovdiri = 1403,                       /* -mmovdiri */
  OPT_mmpx = 1404,                           /* -mmpx */
  OPT_mms_bitfields = 1405,                  /* -mms-bitfields */
  OPT_mmwaitx = 1406,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1407,            /* -mno-align-stringops */
  OPT_mno_default = 1408,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1409,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1410,                  /* -mno-push-args */
  OPT_mno_red_zone = 1411,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1412,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1413,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1414,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1415,                          /* -mpc32 */
  OPT_mpc64 = 1416,                          /* -mpc64 */
  OPT_mpc80 = 1417,                          /* -mpc80 */
  OPT_mpclmul = 1418,                        /* -mpclmul */
  OPT_mpcommit = 1419,                       /* -mpcommit */
  OPT_mpconfig = 1420,                       /* -mpconfig */
  OPT_mpku = 1421,                           /* -mpku */
  OPT_mpopcnt = 1422,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1423, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1424,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1425,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1426,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1427,                        /* -mprfchw */
  OPT_mptwrite = 1428,                       /* -mptwrite */
  OPT_mpush_args = 1429,                     /* -mpush-args */
  OPT_mrdpid = 1430,                         /* -mrdpid */
  OPT_mrdrnd = 1431,                         /* -mrdrnd */
  OPT_mrdseed = 1432,                        /* -mrdseed */
  OPT_mrecip = 1433,                         /* -mrecip */
  OPT_mrecip_ = 1434,                        /* -mrecip= */
  OPT_mrecord_mcount = 1435,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1436,                 /* -mrecord-return */
  OPT_mred_zone = 1437,                      /* -mred-zone */
  OPT_mregparm_ = 1438,                      /* -mregparm= */
  OPT_mrtd = 1439,                           /* -mrtd */
  OPT_mrtm = 1440,                           /* -mrtm */
  OPT_msahf = 1441,                          /* -msahf */
  OPT_msgx = 1442,                           /* -msgx */
  OPT_msha = 1443,                           /* -msha */
  OPT_mshstk = 1444,                         /* -mshstk */
  OPT_mskip_rax_setup = 1445,                /* -mskip-rax-setup */
  OPT_msoft_float = 1446,                    /* -msoft-float */
  OPT_msse = 1447,                           /* -msse */
  OPT_msse2 = 1448,                          /* -msse2 */
  OPT_msse2avx = 1449,                       /* -msse2avx */
  OPT_msse3 = 1450,                          /* -msse3 */
  OPT_msse4 = 1451,                          /* -msse4 */
  OPT_msse4_1 = 1452,                        /* -msse4.1 */
  OPT_msse4_2 = 1453,                        /* -msse4.2 */
  OPT_msse4a = 1454,                         /* -msse4a */
  /* OPT_msse5 = 1455, */                    /* -msse5 */
  OPT_msseregparm = 1456,                    /* -msseregparm */
  OPT_mssse3 = 1457,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1458,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1459, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1460,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1461, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1462,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1463,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1464,            /* -mstringop-strategy= */
  OPT_mstv = 1465,                           /* -mstv */
  OPT_mtbm = 1466,                           /* -mtbm */
  OPT_mtls_dialect_ = 1467,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1468,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1469,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1470,                         /* -mtune= */
  OPT_mvaes = 1471,                          /* -mvaes */
  OPT_mveclibabi_ = 1472,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1473,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1474,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1475,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1476,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1477,                      /* -mwbnoinvd */
  OPT_mx32 = 1478,                           /* -mx32 */
  OPT_mxop = 1479,                           /* -mxop */
  OPT_mxsave = 1480,                         /* -mxsave */
  OPT_mxsavec = 1481,                        /* -mxsavec */
  OPT_mxsaveopt = 1482,                      /* -mxsaveopt */
  OPT_mxsaves = 1483,                        /* -mxsaves */
  OPT_n = 1484,                              /* -n */
  OPT_name_sort = 1485,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1486,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1487,              /* -no-integrated-cpp */
  OPT_no_pie = 1488,                         /* -no-pie */
  OPT_nocpp = 1489,                          /* -nocpp */
  OPT_nodefaultlibs = 1490,                  /* -nodefaultlibs */
  OPT_nolibc = 1491,                         /* -nolibc */
  OPT_nophoboslib = 1492,                    /* -nophoboslib */
  OPT_nostartfiles = 1493,                   /* -nostartfiles */
  OPT_nostdinc = 1494,                       /* -nostdinc */
  OPT_nostdinc__ = 1495,                     /* -nostdinc++ */
  OPT_nostdlib = 1496,                       /* -nostdlib */
  OPT_o = 1497,                              /* -o */
  OPT_objects = 1498,                        /* -objects */
  OPT_p = 1499,                              /* -p */
  OPT_pass_exit_codes = 1500,                /* -pass-exit-codes */
  /* OPT_pedantic = 1501, */                 /* -pedantic */
  OPT_pedantic_errors = 1502,                /* -pedantic-errors */
  OPT_pg = 1503,                             /* -pg */
  OPT_pie = 1504,                            /* -pie */
  OPT_pipe = 1505,                           /* -pipe */
  OPT_print_file_name_ = 1506,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1507,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1508,          /* -print-multi-directory */
  OPT_print_multi_lib = 1509,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1510,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1511,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1512,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1513,               /* -print-prog-name= */
  OPT_print_search_dirs = 1514,              /* -print-search-dirs */
  OPT_print_sysroot = 1515,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1516,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1517,                    /* -print-value */
  OPT_quiet = 1518,                          /* -quiet */
  OPT_r = 1519,                              /* -r */
  OPT_remap = 1520,                          /* -remap */
  OPT_reverse_sort = 1521,                   /* -reverse-sort */
  OPT_s = 1522,                              /* -s */
  OPT_save_temps = 1523,                     /* -save-temps */
  OPT_save_temps_ = 1524,                    /* -save-temps= */
  OPT_shared = 1525,                         /* -shared */
  OPT_shared_libgcc = 1526,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1527,               /* -shared-libphobos */
  OPT_size_sort = 1528,                      /* -size-sort */
  /* OPT_specs = 1529, */                    /* -specs */
  OPT_specs_ = 1530,                         /* -specs= */
  OPT_static = 1531,                         /* -static */
  OPT_static_libasan = 1532,                 /* -static-libasan */
  OPT_static_libgcc = 1533,                  /* -static-libgcc */
  OPT_static_libgfortran = 1534,             /* -static-libgfortran */
  OPT_static_libgo = 1535,                   /* -static-libgo */
  OPT_static_liblsan = 1536,                 /* -static-liblsan */
  OPT_static_libmpx = 1537,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1538,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1539,               /* -static-libphobos */
  OPT_static_libstdc__ = 1540,               /* -static-libstdc++ */
  OPT_static_libtsan = 1541,                 /* -static-libtsan */
  OPT_static_libubsan = 1542,                /* -static-libubsan */
  OPT_static_pie = 1543,                     /* -static-pie */
  /* OPT_std_c__03 = 1544, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1545, */                /* -std=c++0x */
  OPT_std_c__11 = 1546,                      /* -std=c++11 */
  OPT_std_c__14 = 1547,                      /* -std=c++14 */
  OPT_std_c__17 = 1548,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1549, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1550, */                /* -std=c++1z */
  OPT_std_c__2a = 1551,                      /* -std=c++2a */
  OPT_std_c__98 = 1552,                      /* -std=c++98 */
  OPT_std_c11 = 1553,                        /* -std=c11 */
  OPT_std_c17 = 1554,                        /* -std=c17 */
  /* OPT_std_c18 = 1555, */                  /* -std=c18 */
  /* OPT_std_c1x = 1556, */                  /* -std=c1x */
  OPT_std_c2x = 1557,                        /* -std=c2x */
  /* OPT_std_c89 = 1558, */                  /* -std=c89 */
  OPT_std_c90 = 1559,                        /* -std=c90 */
  OPT_std_c99 = 1560,                        /* -std=c99 */
  /* OPT_std_c9x = 1561, */                  /* -std=c9x */
  OPT_std_f2003 = 1562,                      /* -std=f2003 */
  OPT_std_f2008 = 1563,                      /* -std=f2008 */
  OPT_std_f2008ts = 1564,                    /* -std=f2008ts */
  OPT_std_f2018 = 1565,                      /* -std=f2018 */
  OPT_std_f95 = 1566,                        /* -std=f95 */
  OPT_std_gnu = 1567,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1568, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1569, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1570,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1571,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1572,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1573, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1574, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1575,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1576,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1577,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1578,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1579, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1580, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1581,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1582, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1583,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1584,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1585, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1586, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1587,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1588, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1589, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1590, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1591, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1592, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1593,                     /* -std=legacy */
  OPT_symbol_ = 1594,                        /* -symbol= */
  OPT_symbolic = 1595,                       /* -symbolic */
  OPT_t = 1596,                              /* -t */
  OPT_time = 1597,                           /* -time */
  OPT_time_ = 1598,                          /* -time= */
  OPT_traditional = 1599,                    /* -traditional */
  OPT_traditional_cpp = 1600,                /* -traditional-cpp */
  OPT_tree_stats = 1601,                     /* -tree-stats */
  OPT_trigraphs = 1602,                      /* -trigraphs */
  OPT_type_stats = 1603,                     /* -type-stats */
  OPT_u = 1604,                              /* -u */
  OPT_undef = 1605,                          /* -undef */
  OPT_v = 1606,                              /* -v */
  OPT_version = 1607,                        /* -version */
  OPT_w = 1608,                              /* -w */
  OPT_wrapper = 1609,                        /* -wrapper */
  OPT_x = 1610,                              /* -x */
  OPT_z = 1611,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
